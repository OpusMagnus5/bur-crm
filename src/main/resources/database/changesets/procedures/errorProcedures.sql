...
CREATE OR REPLACE PROCEDURE error_add_new(
    ...
    IN _err_date error.err_date%TYPE,
...
BEGIN
    ...
    INSERT INTO error (err_uuid, err_user_id, err_date, err_class, err_message, err_stacktrace, err_is_web)
    VALUES (_err_uuid, _err_user_id, _err_date, _err_class, _err_message, _err_stacktrace, COALESCE(_err_is_web, false));
