...
class OperatorWriteRepository implements IOperatorWriteRepository {
    ...
    public OperatorWriteRepository(IJdbcCaller jdbcCaller) {
        this.jdbcCaller = jdbcCaller;
        this.createNewProc = jdbcCaller.buildSimpleJdbcCall("operator_create_new");
        this.deleteProc = jdbcCaller.buildSimpleJdbcCall("operator_delete");
        this.updateProc = jdbcCaller.buildSimpleJdbcCall("operator_update");
    }
